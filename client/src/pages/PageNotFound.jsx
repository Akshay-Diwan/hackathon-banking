...
const PageNotFound = () => {
  ...
  <div className="text-center">
    ...
    <p className="mt-6 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">Sorry, we couldn’t find the page you’re looking for.<br/>    Ask ChatBot for any help</p>
